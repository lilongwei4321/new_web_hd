...
function getMessage(msg) {
    ...
    switch (msg.type) {
        case 'text':
            /*var reg = /(&lt;a&nbsp;href=&#39;.*?html)|(&lt;\/a&gt;&nbsp;&lt;br&gt;&nbsp;)|(&lt;\/a&gt;)|(&#39;&gt;)|(&nbsp;&lt;br&gt;&nbsp;)/gi;
            ...
            str = str.replace(re, "<a href='$1' target='_blank' style='display:block;margin-bottom:5px;'>$1</a>");
            str = buildEmoji(str);
...
function getAvatar(url) {
    ...
    if (re.test(url)) {
        ...
        return "/hd/assets/images/customer-pic.png"
    }
}
